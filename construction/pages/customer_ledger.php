            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div id="maintable">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                for($i=0; $row = $result->fetch(); $i++){
                                    ?>
                                    <tr class="record">
                                        <td>TR-0<?php echo $row['transaction_id']; ?></td>
                        ...
                        <a rel="facebox" id="addd" class="btn btn-primary" href="addledger.php?invoice=<?php echo $_GET['cname']; ?>&bamount=<?php echo $tamount; ?>" style="margin-top: 10px;">Add Payment</a><br><br>
