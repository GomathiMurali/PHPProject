 ...
 <form action="saveledger.php" method="post" class = "form-group">
 	<input type="text" name="name" class = "form-control" value="<?php echo $_GET['invoice']; ?>" />
 	<input type="text" name="invoice" class = "form-control" value="<?php echo $finalcode; ?>" />
 	<input type="text" name="tot" class = "form-control" value="<?php echo $_GET['bamount']; ?>" />
 	<div id="ac">
