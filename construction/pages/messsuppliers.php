...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mess Transactions</h1>
                </div>
                <div id="maintable">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
						...
						$accno=$_GET['no'];
                        $result = $db->prepare("SELECT * FROM mess_supervisor where subcatagory= :c ORDER BY id asc");
					 ...
					 <thead>
                            <tr>
                                ...
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(amount)-sum(debit_amount) as bal FROM mess_supervisor where subcatagory= :c ORDER BY id asc");
