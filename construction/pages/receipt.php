  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <form action="savereceipt.php" method="post" class ="form-group">
         <?php 
	   include('connect.php');
	    $results = $db->prepare("SELECT max(id) FROM receipt");
        ...
        ?>
		<?php $y=date('y'); ?>
         <?php $vno="CR".$y.'-'. str_pad($dsdsdf+1,4,'0',STR_PAD_LEFT)?>
		...
		<label>Voucher No: </label><input type = "text" style="width: 300px;" class = "form-control" name = "voucherno" value = "<?php echo $vno; ?>"/>
		<label>Account Head: </label><input type = "text" style="width: 300px;" class = "form-control" name = "acchead">
		<input type = "hidden" style="width: 300px;" class = "form-control" name = "amountr">
		
         <label>Towards: </label><input type = "text" style="width: 300px;" class = "form-control" name = "towards">
		 <label>Amount: </label><input type = "text" style="width: 300px;" class = "form-control" name = "amount">
        </div>
		 <div class="column1">
