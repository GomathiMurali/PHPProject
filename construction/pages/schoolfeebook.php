...
<body>
    ...
    <div id="page-wrapper" >
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">School Fee Book</h2>
                </div>
                <div id="maintable" >
                    <div style="margin-top: -19px; margin-bottom: 21px;">
                    </div>
					<form action="saveschoolfeebook.php" method="post" class = "form-group">
					...
					include('connect.php');
												    ...
												    $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='School Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Malar Term-I' ");
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='School Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Malar Term-II' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='School Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='CBSE Term-I' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='School Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='CBSE Term-II' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='School Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Kidz Term-I' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='School Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Kidz Term-II' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
