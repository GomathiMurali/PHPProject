            ...
            <div class="row">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Add Loan Transactions</h4>
                                    </div>
                                    <div class="modal-body">

                                     <form action="saveloanentry.php" method="post" class = "form-group">
                                        <div id="ac">
										<label>Name</label><br />
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        include('connect.php');
						$accno=$_GET['no'];
                        $result = $db->prepare("SELECT * FROM loanentry where account= :c ORDER BY id asc");
                        ...
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
							   ...
							   <td><?php echo $balance = ($balance + $row['amount'] - $row['debit_amount']) ;?></td>
                                <td>
								<!--<a rel="facebox" class="btn btn-primary" href="editloanentry.php?id=<?php echo $row['expense_id']; ?>&no=<?php echo $row['account']; ?>"> <i class="fa fa-pencil"></i> </a>-->
								<a href="deleteloanentry.php?id=<?php echo $row['expense_id']; ?>" class="btn btn-danger delbutton" title="Click To Delete"><i class = "fa fa-trash"></i></a></td>
                            </tr>
                            <?php
                        }
                        ?>
					 ...
					 <thead>
                            <tr>
                                ...
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(balance) FROM loanentry where account= :c ");
