...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Expense Pending</h1>
                </div>
                <div id="maintable">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                     ...
                                     <form action="saveexpensepending.php" method="post" class = "form-group" enctype="multipart/form-data">
										...
										<input type="text"  value = "Payable Expense A/C" style="width: 400px;" class = "form-control" name="name" />
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
						...
						$from 	= date('d-m-Y', strtotime($frmm));
						$to 	= date('d-m-Y', strtotime($tom)); */
                        $result = $db->prepare("SELECT * FROM expensepending ORDER BY id asc");
                        ...
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
								...
								<a href="deleteexpensepending.php?id=<?php echo $row['pending_id']; ?>&status=<?php echo $row['status']; ?>" class="btn btn-danger delbutton" title="Click To Delete"><i class = "fa fa-trash"></i></a></td>
                            </tr>
                            <?php
