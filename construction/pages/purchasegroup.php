  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <form action="purchasesales.php" method="get" class = "form-group" >
<div align="center">
...
<br><br>
											<select name="groupname" style="width: 300px;" class="chzn-select" >
											 ...
											 ?>
											  ...
											  <br>
			<label>Ref. Invoice</label><br />
          <select  name="refinvoice"  style="width:300px;" class="chzn-select" required>
           <option></option>
           <?php
           include('connect.php');
           $result = $db->prepare("SELECT * FROM purchaseorder");
           $result->bindParam(':userid', $res);
           $result->execute();
           for($i=0; $row = $result->fetch(); $i++){
            ?>
            <option value="<?php echo $row['invoice'];?>" 
		...
		<label>Bank Details</label><br />
          <select  name="bank"  style="width:300px;" class="chzn-select" required>
           <option> Select a Account No</option>
           <?php
           include('connect.php');
           ...
           for($i=0; $row = $result->fetch(); $i++){
            ?>
            <option value="<?php echo $row['accno'];?>" 
