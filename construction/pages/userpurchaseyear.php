  ...
  <div id="wrapper">
	...
	<div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="userpurchaseyearreport.php" method="post" class = "form-group" >
<div align="center">
         <input type="hidden"  style="width: 300px;" class = "form-control" name="name" value = "<?php echo $uname;?>" /><br>
          Year <input type="text"  style="width: 300px;" class = "form-control" name="year" value = "<?php echo date('Y')?>" /><br>
