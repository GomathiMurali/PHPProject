      ...
      <div class="container-fluid">
       ...
       ?></h3>
        ...
        <div class="panel-body">
         ...
         <form action="savepurchasesales.php" method="post" class ="form-group">
		  <?php 
	   include('connect.php');
	    $results = $db->prepare("SELECT max(id) FROM purchaseform");
    ...
    ?>
      ...
      <tbody>
       ...
       for($i=0; $row = $result->fetch(); $i++){
		...
		<td><a href="deletepurchaselist.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>&bank=<?php echo $bank;?>&refinvoice=<?php echo $refinvoice;?>&groupname=<?php echo $groupname;?>"> Delete</a></td>
...
<a  class="btn btn-primary"  href="printpur2.php?invoice=<?php echo $_GET['invoice'];?>&total=<?php echo $fgfg; ?>&name=<?php echo $supp; ?>&date=<?php echo $duedate; ?>&phone=<?php echo $phone;?>&bank=<?php echo $bank;?>&refinvoice=<?php echo $refinvoice;?>">Print</a>
