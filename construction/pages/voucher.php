    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Kollimalai</li>
        </ol>
    <h1>Kollimalai</h1>
        <hr>
        <div class="panel-body">
                    ...
                    <button class="btn btn-success" data-toggle="modal" onclick=" myFunction() " value="Print">
                      <a href="kollimalai.php" style="color:white">  Print</a>
                    </button>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                               ...
                               <div class="modal-body">
                                    <form action="kollimalaisave.php" method="post" class = "form-group">
                                        <div id="ac">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable12" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM addgroup4 ORDER BY id DESC");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
                                ...
                                <td><a rel="facebox" class="btn btn-primary" href="kollimalaiedit.php?id=<?php echo $row['id']; ?>"> <i class="">Edit</i> </a>  </td>
                                <td>
