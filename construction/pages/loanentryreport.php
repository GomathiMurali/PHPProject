                ...
                <div id="maintable" >
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" >
                        ...
                        <tbody>
							...
							$e=$name;
							$f='31-03-2018';
                            $result = $db->prepare("SELECT * FROM loanentry where account=:e AND STR_TO_DATE(date, '%d-%m-%Y') BETWEEN STR_TO_DATE('$c', '%d-%m-%Y') AND STR_TO_DATE('$d', '%d-%m-%Y')  ORDER BY id");
                        ...
                        <thead>
                            <tr>
                                <th colspan="4" style="border-top:1px solid #999999"> Remaining amount to pay  </th>
                                <th colspan="3" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(balance) FROM loanentry where account= :e AND STR_TO_DATE(date, '%d-%m-%Y') BETWEEN STR_TO_DATE('$f', '%d-%m-%Y') AND STR_TO_DATE('$d', '%d-%m-%Y') ");
