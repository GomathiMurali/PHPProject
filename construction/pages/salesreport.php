        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="maintable">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(total_amount) FROM sales ");
                                    $results->execute();
					...
					<a href="viewaccountable.php" class="btn btn-primary"><i class="icon-print icon-large"></i>View Acc Rep</a>
					<a href="viewunaccountable.php" class="btn btn-primary"><i class="icon-print icon-large"></i>View UnAcc Rep</a>
					<br>
                </div>
            </div>
