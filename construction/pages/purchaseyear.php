  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="purchaseyearreport.php" method="post" class = "form-group" >
<div align="center">
         
        Year :<br> <input type="text"  style="width: 300px;" class = "form-control" name="year" value = "<?php echo date('Y');?>" /><br>
