    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
				<form method="post">
                    <h1 class="page-header">Annexure-I</h1>
					 ...
					 <select name="mon" id="month" class = "form-control" onchange="this.form.submit()">
							...
							<br>
							<!--<input type="text" name="rsi" id="rsi" class="form-control" />-->
							<?php
                ...
                <div id="maintable">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
						<tr><th colspan="8">Annexure-I</th></tr>
                            <tr>
                                <th > S.No </th>
                        ...
                        <tbody>
                            ...
                            <?php
                            include('connect.php');
                            $result = $db->prepare("SELECT * FROM purchases_item where status='Accountable' AND month=:m AND year=year(curdate())");
