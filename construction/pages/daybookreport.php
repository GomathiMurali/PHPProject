...
<body>
    ...
    <div id="page-wrapper" >
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Daybook Report</h2>
                </div>
                <div id="maintable" >
					...
					<thead>
					<tr><th colspan="5" bgcolor="#AED6F1"  >Date:<?php echo $today1;?></th></tr></thead>
					<?php
                            include('connect.php');
							$i=$day_before;
							$n='31-03-2018';
					...
					<?php
							...
							<?php $ob=$obh+$obb; ?>
					<thead>
					<tr><th colspan="5" bgcolor="#A9DFBF  ">Opening balance:&nbsp;&nbsp;<?php echo formatMoney($ob,true);?></th></tr></thead>
					<thead>
					<tr><th colspan="5" bgcolor="#A9DFBF  ">Opening balance in hand:&nbsp;&nbsp;<?php echo formatMoney($obh,true);?></th></tr></thead>
					<thead>
					<tr><th colspan="5" bgcolor="#D7BDE2">Opening balance in bank:&nbsp;&nbsp;<?php echo formatMoney($obb,true);?></th></tr></thead>
                            ...
                            for($i=0; $row = $result->fetch(); $i++){
                                ...
                                <tr class="record">
                                    ...
                                    <td align="right"><?php
										...
										if($ttt=='Bank')
										{?>
									    <span style="color:red;text-align:center;"><?php echo formatMoney($dsdsd, true); ?></span>
										<?php
										}
										else
										{
                        ...
                        <thead>
                            <tr>
                                ...
                                <td colspan="2" align="right" style="font-weight:bold"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(amount) FROM income where date=:c and trans='Cash' ");
                        ...
                        <thead>
                            <tr>
                                ...
                                <td colspan="2" align="right" style="font-weight:bold"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(amount) FROM expense where date=:c and trans='Cash' ");
									$results->bindParam(':c', $c);
