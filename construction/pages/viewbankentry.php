            ...
            <div class="row">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
						...
						$d='31-08-2018';
						$accno=$_POST['no'];
                        $result = $db->prepare("SELECT * FROM bankentry where account= :c AND date=:d ORDER BY id DESC");
                        ...
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
                               ...
                               <!-- <td><a rel="facebox" class="btn btn-primary" href="editbankentry.php?id=<?php echo $row['id']; ?>&no=<?php echo $row['description']; ?>"> <i class="fa fa-pencil"></i> </a>             
					 ...
					 <thead>
                            <tr>
                                ...
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(balance) FROM bankentry where account= :c AND STR_TO_DATE(date, '%d-%m-%Y') BETWEEN STR_TO_DATE('$d', '%d-%m-%Y') AND STR_TO_DATE('$c', '%d-%m-%Y') ");
