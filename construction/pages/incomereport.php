...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Total Income Report <?php echo $from1;?> to <?php echo $to1;?></h2>
                </div>
                <div id="maintable" >
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" >
                        ...
                        <tbody>
                            ...
                            $c=$from1;
							$d=$to1;
                            $result = $db->prepare("SELECT * FROM income where STR_TO_DATE(date, '%d-%m-%Y') BETWEEN STR_TO_DATE('$c', '%d-%m-%Y') AND STR_TO_DATE('$d', '%d-%m-%Y') ORDER BY in_id");
