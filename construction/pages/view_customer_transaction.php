        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead>
					<tr><th colspan="6">Customer Transaction Report</th></tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        include('connect.php');
                        $id=$_GET['id'];
                        $result = $db->prepare("SELECT * FROM sales WHERE name= :userid AND type='credit'");
                        ...
                        <thead>
                            <tr>
                                ...
                                <td class = "right" colspan="3" style="border-top:1px solid #999999"> 
                                    ...
                                    <?php
                                    $id = $_GET['id'];
                                    $results = $db->prepare("SELECT sum(amount) FROM sales WHERE name = :name AND type='credit' ");
                            ...
                            <tr>
                                ...
                                <th colspan="" style="border-top:1px solid #999999">
                                  <th colspan="3" style="border-top:1px solid #999999"> 
                                     <?php
                                     $id = $_GET['id'];
                                     $results = $db->prepare("SELECT sum(balance) FROM sales WHERE name = :name AND type='credit' ");
                                     $results->bindParam(':name', $id);
                                     $results->execute();
                                     for($i=0; $rows = $results->fetch(); $i++){
                ...
                <div class="clearfix"></div>
				 <div id="maintable"><div style="margin-top: -19px; margin-bottom: 21px;"></div>
