            ...
            <div class="row">
                ...
                <div id="maintable" >
					...
					<thead>
						...
						<thead>
						 ...
						 <?php
							...
							$c=$from1;
							$d=$to1;
                            $result = $db->prepare("SELECT account,sum(balance) FROM bankentry where date BETWEEN :c AND :d GROUP BY account");
                        ...
                        <thead>
						 ...
						 <?php
							...
							$c=$from1;
							$d=$to1;
                            $result = $db->prepare("SELECT catagory_name,subcatagory,sum(amount) FROM income where date BETWEEN :c AND :d GROUP BY subcatagory,catagory_name");
							$result->bindParam(':c', $c);
                            $result->bindParam(':d', $d);
                            $result->execute();
                            for($i=0; $row = $result->fetch(); $i++){
					...
					<table width="100%"  id="dataTables-example" border="1">
                        ...
                        <thead>
                            <tr>
                                <th colspan="4" style="border-top:1px solid #999999">Payable Expense</th>
                            </tr>
                        </thead>
					     <thead>
                            <tr>
						 ...
						 <?php
							...
							$c=$from1;
							$d=$to1;
                            $result = $db->prepare("SELECT description,sum(amount)-sum(paidamount) AS balance FROM expensepending where date BETWEEN :c AND :d GROUP BY description");
							$result->bindParam(':c', $c);
                            $result->bindParam(':d', $d);
                            $result->execute();
                            for($i=0; $row = $result->fetch(); $i++){
                        ...
                        <thead>
                            <tr>
                                ...
                                <td colspan="1" align="right" style="font-weight:bold"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(amount)-sum(paidamount) AS balance FROM expensepending where date BETWEEN :c AND :d ");
									$results->bindParam(':c', $c);
                                    $results->bindParam(':d', $d);
                                    $results->execute();
                                    for($i=0; $rows = $results->fetch(); $i++){
					...
					<table width="100%"   id="dataTables-example" border="1">
                        <thead>
						 ...
						 <?php
							...
							$c=$from1;
							$d=$to1;
                            $result = $db->prepare("SELECT catagory_name,subcatagory,sum(amount) FROM expense where date BETWEEN :c AND :d GROUP BY subcatagory,catagory_name");
							$result->bindParam(':c', $c);
                            $result->bindParam(':d', $d);
                            $result->execute();
                            for($i=0; $row = $result->fetch(); $i++){
