...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Accounts Payable Report</h1>
                </div>
            </div>
            <div id="maintable">
                <div style="margin-top: -19px; margin-bottom: 21px;">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
						<tr><th colspan="6">Accounts Payable Report</th></tr>
                            <tr>
                                <th > ID </th>
                                <th > Date </th>
                                <th > Supplier </th>
                        ...
                        <tbody>
                            ...
                            $c='credit';
                            $d='paid';
                            $result = $db->prepare("SELECT * FROM purchases_item WHERE status='Unaccountable'");
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="3" style="border-top:1px solid #999999"> 
                                        ...
                                        $c='credit';
                                        $results = $db->prepare("SELECT sum(total_amount) FROM purchases_item WHERE status='Unaccountable'");
