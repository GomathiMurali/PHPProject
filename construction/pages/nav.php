...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
			...
			<h1 class="avatar1"><b>Mahendra Feeds & Foods</b></h1>
        </div>
        <!-- Top Menu Items -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" style="background-color:green ;">
            <ul class="nav navbar-nav side-nav" style="background-color:black ;">
                <li><a href="home.php"><i class="fa fa-home fa-fw"></i> Home</a></li>
					...
					<li>
						<a href="catagory.php"><i class="fa fa-table fa-fw"></i> Category</a>
					</li>
					<li>
					...
					<li>
						<a href="orderpo.php"><i class="fa fa-list-alt fa-fw"></i> Purchase</a>
					</li>
					<li>
						<a href="sales.php?invoice=<?php echo $finalcode;?>"><i class="fa fa-list-alt fa-fw"></i> Sales</a>
					</li>
					<li>
