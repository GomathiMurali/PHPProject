...
<nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="mff.ico" class="avatar"> </a><h2 class="avatar1"><b>Mahendra</b></h2>
            </div>
		...
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="catagory.php"><i class="fa fa-bar-chart-o"></i> Add Category</a>
                    </li>
                    <li>
                        <a href="group.php"><i class="fa fa-qrcode"></i>  Add Group</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="#">Sales Report<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="salesdate.php">Date Wise Report</a>
                                    </li>
                                    <li>
                                        <a href="salesdatecustomer.php">Customer Wise Report</a>
                                    </li>
							...
							<li>
                                <a href="#">Purchase Report<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="purchasedate.php">Date Wise Report</a>
                                    </li>
                                    <li>
                                        <a href="purchasedatecustomer.php">Customer Wise Report</a>
                                    </li>
