                ...
                <div style="margin-top: -19px; margin-bottom: 21px;">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            $c='credit';
                            $d='paid';
                            $result = $db->prepare("SELECT * FROM purchases_item WHERE status='Accountable'");
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="3" style="border-top:1px solid #999999"> 
                                        ...
                                        $c='credit';
                                        $results = $db->prepare("SELECT sum(total_amount) FROM purchases_item WHERE status='Accountable'");
