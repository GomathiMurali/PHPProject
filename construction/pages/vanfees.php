...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Van Fee</h1>
                </div>
                <div id="maintable">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Add Van Fee</h4>
                                    </div>
                                    <div class="modal-body">

                                     <form action="savevanfees.php" method="post" class = "form-group">
                                        <div id="ac">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM vanfee ORDER BY id DESC");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
                                ...
                                <td><a rel="facebox" class="btn btn-primary" href="editvanfees.php?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil"></i> </a>               <a href="#"id="<?php echo $row['id']; ?>" class="btn btn-danger delbutton" title="Click To Delete"><i class = "fa fa-trash"></i></a></td>
                            </tr>
                            <?php
                        }
                        ?>
