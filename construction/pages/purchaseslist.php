            ...
            <tr class="record">
             ...
             <td style="display:none"><?php
              ...
              <td><?php
                ...
                <a rel="facebox" class = "btn btn-primary" href="stockin.php?date=<?php echo $row['date_deliver']; ?>&qty=<?php echo $row['qty']; ?>&iv=<?php echo $row['invoice_number']; ?>&pname=<?php echo $row['p_name'];?>">
                <span><i class="fa fa-pencil"></i></span></a>
                <a class = "btn btn-primary"  href="printpo.php?id=<?php echo $row['invoice_number']; ?>&supplier=<?php echo $row['suplier']; ?>&dstatus=<?php echo$row['d_status']; ?>&pname=<?php echo $row['p_name'];?>"><span><i class="fa fa-print"></i></span></a> 
                </td>
              </tr>
              <?php
            }
