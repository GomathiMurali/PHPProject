...
$finalcode1='IN-'.createRandomPassword();
?>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<?php
		    $sdsd=$_GET['invoice'];
			$resultas = $db->prepare("SELECT sum(total_amount) FROM purchaseorder WHERE invoice= :a");
       ...
       ?></h3>
        ...
        <div class="panel-body">
         ...
         <form action="savepurchasesalesorder.php" method="post" class ="form-group">
		  <?php 
	   include('connect.php');
	    $results = $db->prepare("SELECT max(id) FROM purchaseorder");
...
<br>
 ...
 <?php
    $id=$_GET['invoice'];
    include('connect.php');
    $resultaz = $db->prepare("SELECT * FROM purchaseorder WHERE invoice= :xzxz");
...
//echo 'Status : '.$rowaz['status'].'<br>';
    ...
    ?>
      ...
      <tbody>
       ...
       $id=$_GET['invoice'];
       include('connect.php');
       $result = $db->prepare("SELECT * FROM purchaseorder WHERE invoice= :userid");
       ...
       for($i=0; $row = $result->fetch(); $i++){
		...
		<td><a href="deletepurchaseorderlist.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>&bank=<?php echo $bank;?>&groupname=<?php echo $groupname;?>"> Delete</a></td>
...
<a  class="btn btn-primary"  href="printpurchaseorder.php?invoice=<?php echo $_GET['invoice'];?>&total=<?php echo $fgfg; ?>&name=<?php echo $supp; ?>&date=<?php echo $duedate; ?>&phone=<?php echo $phone;?>&bank=<?php echo $bank;?>">Print</a>
