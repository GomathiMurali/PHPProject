            ...
            <div class="row">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        ...
                        include('connect.php');
						$c=$from1;
                        $result = $db->prepare("SELECT * FROM income where date=:c ORDER BY in_id DESC");
                        ...
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
                                ...
                                <td><a rel="facebox" class="btn btn-primary" href="editincome.php?id=<?php echo $row['in_id']; ?>&date=<?php echo $from1; ?>"> <i class="fa fa-pencil"></i> </a>               <a href="#"id="<?php echo $row['in_id']; ?>" class="btn btn-danger delbutton" title="Click To Delete"><i class = "fa fa-trash"></i></a></td>
                            </tr>
                            <?php
                        }
                        ?>
