    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
       ...
       ?></h3>
        ...
        <form action="savesalesorder.php" method="post" class ="form-group">
		<?php 
	   include('connect.php');
    ...
    ?>
      ...
      <tbody>
       ...
       for($i=0; $row = $result->fetch(); $i++){
		...
		<td><a href="deletesalesorderlist.php?id=<?php echo $row['id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>&bank=<?php echo $bank;?>&groupname=<?php echo $groupname;?>"> Delete</a></td>
...
<a  class="btn btn-primary"  href="printsalesorder.php?invoice=<?php echo $_GET['invoice'];?>&total=<?php echo $fgfg; ?>&name=<?php echo $supp; ?>&date=<?php echo $duedate; ?>&phone=<?php echo $phone;?>&bank=<?php echo $bank;?>">Print</a>
