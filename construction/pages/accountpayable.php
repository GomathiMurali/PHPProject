...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Purchase Report <?php echo $from1;?> to <?php echo $to1;?></h2>
                </div>
            </div>
            <div id="maintable">
                <div style="margin-top: -19px; margin-bottom: 21px;">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
						<tr><th colspan="6">Purchase Report</th></tr>
                            <tr>
                                <th > ID </th>
                                <th > Date </th>
                                <th > Supplier </th>
					...
					<!--<a href="viewaccountable1.php" class="btn btn-primary"><i class="icon-print icon-large"></i>View Acc Rep</a>
					<a href="viewunaccountable1.php" class="btn btn-primary"><i class="icon-print icon-large"></i>View UnAcc Rep</a>-->
