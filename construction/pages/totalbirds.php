...
<body id="page-top">
  ...
  <a class="navbar-brand mr-1" href="home.php"><img src="ppf1.png" style="width: 70px;height: auto;"><span style="font-size: 15px;">Poongodi Poultry Farm </span></a>
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
   <ul class="sidebar navbar-nav" style="background-image: url(head11.jpg);">
      <li class="nav-item active">
	   ...
	   <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="catagory.php">
          <i class="fa fa-table fa-fw"></i>
          <span>Egg Cost</span></a>
     
        <a class="dropdown-item" href="voucher.php">
          <i class="fa fa-table fa-fw"></i>
          <span>Stock Statement</span></a>
      </div>
	  </li>
	      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
     ...
     <div class="dropdown-menu" aria-labelledby="pagesDropdown">
        ...
        <a class="dropdown-item" href="default.php">
          <i class="fa fa-truck fa-fw"></i>
          <span>Default Satement</span></a>
     <!--
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Egg report</li>
        </ol>
		<h1>Egg details statement</h1>
        <hr>
        <div class="panel-body">
                    
                    
       <form action="savevoucher.php" method="post" class ="form-group">
       <?php 
	   include('connect.php');
	    $results = $db->prepare("SELECT max(id) FROM voucher");
		...
		<div class="row">
		<div class="column">
        <label>Total Egg in details : </label><input type="text"  style="width: 300px;" class = "form-control" name="date" value = "<?php echo $today; ?>" />
		<label>Small Egg Details: </label><input type = "text" style="width: 300px;" class = "form-control" name = "voucherno" value = "<?php echo $vno; ?>">
		<label>Large Egg Details: </label><input type = "text" style="width: 300px;" class = "form-control" name = "acchead">
    <label>Medium Egg Details: </label><input type = "text" style="width: 300px;" class = "form-control" name = "acchead">
		<input type = "hidden" style="width: 300px;" class = "form-control" name = "amountr">
		
         <label>Total Egg cost: </label><input type = "text" style="width: 300px;" class = "form-control" name = "towards">
		 <label>Total Feed Cost: </label><input type = "text" style="width: 300px;" class = "form-control" name = "amount">
      <label>Total profit: </label><input type = "text" style="width: 300px;" class = "form-control" name = "amount">
		 </div>
     <!--
		 <div class="column1">
		 <label>Payment Type: </label>
		 <select name="ptype" class="form-control" style="width: 300px;">
		 <option>Cash</option>
		 ...
		 <label>Bank Account: </label>
		  <select name="bank" class = "form-control" >
                             <?php
                                include('connect.php');
                                $result = $db->prepare("SELECT * FROM addbank");
                                $result->bindParam(':userid', $res);
                                $result->execute();
                                for($i=0; $row = $result->fetch(); $i++){
                                    ?>
                                    <option><?php echo $row['bankname']; ?>-<?php echo $row['accno']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
		 <label>Cheque No: </label><input type = "text" style="width: 300px;" class = "form-control" name = "cno">
		
		 
		 <input type = "hidden" style="width: 300px;" class = "form-control" name = "gstno">-->
		 <!-- <label>Receiver Details: </label><input type = "text" style="width: 300px;" class = "form-control" name = "receiver">
		 </div>-->
         </div>
        <br>
