...
<div class="content" id="content">
 ...
 <center><h6> <b><u>Tax Invoice</u></b></h6></center>
 <hr class="new1">
  ...
  <div class="column6">
			...
			<div class="column6">
			Other Ref: <?php echo $refinvoice ?><br><br><br>
			GST No: <br>
			State Code: &nbsp; &nbsp; Phone no: 
		  </div>
			<div class="column6">
  ...
  <tbody>
     ...
     $id=$_GET['invoice'];
     include('connect.php');
	 $resultpp = $db->prepare("SELECT * FROM purchaseform WHERE invoice= :userid");
     ...
     for($i=0; $row = $resultpp->fetch(); $i++){
      ...
      $sdsd=$_GET['invoice'];
      $resultas = $db->prepare("SELECT sum(total_amount),sum(amount),sum(cgstamt),sum(sgstamt),sum(igstamt) FROM purchaseform WHERE invoice= :a");
...
<a href = "userhome.php" class="btn btn-primary btn-m " >
  Back    
</a></center>
