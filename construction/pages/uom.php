    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Anbu Nagar</li>
        </ol>
		<h1>Anbu Nagar</h1>
        <hr>
        <div class="panel-body">
                    ...
                    <button class="btn btn-success" data-toggle="modal" onclick=" myFunction() " value="Print">
                      <a href="anbunagar.php" style="color:white">  Print</a>
                    </button>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                               ...
                               <div class="modal-body">
                                    <form action="anbusave.php" method="post" class = "form-group">
                                        <div id="ac">
            ...
            <tr>
                ...
                <th></th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM addgroup2 ORDER BY id DESC");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ...
                            <tr class="record">
                                ...
                                <td><a rel="facebox" class="btn btn-primary" href="anbueditgroup.php?id=<?php echo $row['id']; ?>"> <i class="">Edit</i> </a>  </td>
                                <td>
