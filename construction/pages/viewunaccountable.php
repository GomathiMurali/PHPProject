            ...
            <div class="row">
                ...
                <div id="maintable">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
						<tr><th colspan="8">Sales Report</th></tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php
                            include('connect.php');
                            $result = $db->prepare("SELECT * FROM sales WHERE btype=2 ORDER BY transaction_id");
                            $result->execute();
                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(total_amount) FROM sales WHERE btype=2 ");
                                    $results->execute();
                            ...
                            <th colspan="5" style="border-top:1px solid #999999" >Total balance </th>
                              <th colspan="1" style="border-top:1px solid #999999">
                                  <th colspan="2" style="border-top:1px solid #999999"> 
                                     <?php
                                     $results = $db->prepare("SELECT sum(balance) FROM sales WHERE btype=2 ");
                                     $results->execute();
                                     for($i=0; $rows = $results->fetch(); $i++){
					...
					<a class = "btn btn-primary" href = "salesreport.php" ><i class = "fa fa-arrow-left"> Back</i></a>
					<br>
                </div>
            </div>
