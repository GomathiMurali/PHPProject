        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="maintable" >
					...
					<form action="savevanfeebook.php" method="post" class = "form-group">
					...
					include('connect.php');
												    ...
												    $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='Van Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Malar Term-I' ");
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='Van Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Malar Term-II' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='Van Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='CBSE Term-I' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='Van Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='CBSE Term-II' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='Van Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Kidz Term-I' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
					...
					include('connect.php');
											        $c=$from1;
													$d=$to1;
													$result = $db->prepare("SELECT sum(amount) FROM income where catagory_name='Van Fee Receipt' AND date BETWEEN :c AND :d AND subcatagory='Kidz Term-II' ");
													$result->bindParam(':c', $c);
													$result->bindParam(':d', $d);
													$result->execute();
													for($i=0; $row = $result->fetch(); $i++){
