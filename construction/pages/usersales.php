      ...
      <div class="container-fluid">
       ...
       ?></h3>
        ...
        <div class="panel-body">
         ...
         <form action="usersavesales.php" method="post" class ="form-group">
		 <?php 
	   include('connect.php');
...
<a  class="btn btn-primary"  href="userprintpur1.php?invoice=<?php echo $_GET['invoice'];?>&total=<?php echo $fgfg; ?>&name=<?php echo $supp; ?>&date=<?php echo $duedate; ?>&refinvoice=<?php echo $refinvoice; ?>&bank=<?php echo $bank; ?>">Print</a>
