	...
	<!-- /.navbar-header -->
      ...
      <ul class="nav navbar-top-links navbar-right"> 
		<li class="dropdown">
			...
			<li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" ><font color="black">Admin User </font><b class="fa fa-angle-down"></b></a>
		...
		<div style="background-color:black ;" class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu" style=" font:bold 14px 'Aleo'; color:black;">
					...
					<li>
						<a href="#"><i class="fa fa-list-alt fa-fw"></i>Company Master<span class="fa arrow"></span></a>
					...
					<li>
						...
						<ul class="nav nav-second-level">
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Sales Report</a>
						<ul class="nav nav-third-level">
						<li><a href="salesdate.php"><i class="fa fa-angle-double-right"></i> Date Wise Report</a></li>
						<li><a href="salesdatecustomer.php"><i class="fa fa-angle-double-right"></i> Customer Wise Report</a></li>
						</ul>
						</li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i> Purchase Report</a>
						<ul class="nav nav-third-level">
						<li><a href="purchasedate.php"><i class="fa fa-angle-double-right"></i> Date Wise Report</a></li>
						<li><a href="purchasedatecustomer.php"><i class="fa fa-angle-double-right"></i> Customer Wise Report</a></li>
						</ul>
						</li>
