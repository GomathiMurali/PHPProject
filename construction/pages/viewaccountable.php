                ...
                <div id="maintable">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <?php
                            include('connect.php');
                            $result = $db->prepare("SELECT * FROM sales WHERE btype=1 ORDER BY transaction_id");
                            $result->execute();
                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(total_amount) FROM sales WHERE btype=1 ");
                                    $results->execute();
                            ...
                            <th colspan="5" style="border-top:1px solid #999999" >Total balance </th>
                              <th colspan="1" style="border-top:1px solid #999999">
                                  <th colspan="2" style="border-top:1px solid #999999"> 
                                     <?php
                                     $results = $db->prepare("SELECT sum(balance) FROM sales WHERE btype=1 ");
                                     $results->execute();
                                     for($i=0; $rows = $results->fetch(); $i++){
