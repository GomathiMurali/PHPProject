                ...
                <div id="maintable" >
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" >
                        ...
                        <tbody>
							...
							$e=$name;
							$f=$subname;
                            $result = $db->prepare("SELECT * FROM expense where credit_type!='Credited' and catagory_name = :e AND subcatagory= :f AND STR_TO_DATE(date, '%d-%m-%Y') BETWEEN STR_TO_DATE('$c', '%d-%m-%Y') AND STR_TO_DATE('$d', '%d-%m-%Y') ORDER BY ex_id");
                            ...
                            for($i=0; $row = $result->fetch(); $i++){
                                ...
                                <tr class="record">
                                    ...
                                    <td>
                                        <a href="#" id="<?php echo $row['in_id']; ?>" class="btn btn-danger delbutton" title="Click To Delete">
                        ...
                        <thead>
                            <tr>
                                <th colspan="7" style="border-top:1px solid #999999"> Total Amount </th>
                                <th colspan="4" style="border-top:1px solid #999999"> 
                                    ...
                                    $results = $db->prepare("SELECT sum(amount) FROM expense where credit_type!='Credited' and catagory_name = :e AND subcatagory= :f AND STR_TO_DATE(date, '%d-%m-%Y') BETWEEN STR_TO_DATE('$c', '%d-%m-%Y') AND STR_TO_DATE('$d', '%d-%m-%Y')  ");
