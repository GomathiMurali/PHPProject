...
--
-- Host: localhost:3306
-- Generation Time: Nov 22, 2019 at 02:17 AM
...
INSERT INTO `products` (`product_id`, `product_code`, `product_name`, `description_name`, `unit`, `cost`, `price`, `mrp`, `supplier`, `qty_left`, `category`, `date_delivered`, `expiration_date`, `ttype`, `cgst`, `sgst`, `igst`, `hsncode`) VALUES
(3, 'P-7230070', '', '', 'feed', '', '', '', NULL, '100', 'egg', '', '', 'Select', '', '', '', '');
