...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2019 at 01:48 PM
...
INSERT INTO `customer` (`customer_id`, `customer_name`, `address`, `contact`, `membership_number`, `first_name`, `middle_name`, `last_name`, `groupname`, `gstno`, `bank`, `gsttype`, `panno`, `cname`, `mobile`, `email`, `emailcc`, `accno`, `branch`, `ifsc`) VALUES
(5, 'Kamalesh', 'Ozone manay tech park,NTT DATA,b block ,3rd floor', '9448691461', '', 'Kamalesh', '', '', 'Dealer', '4567896', 'statebank', 'Regular', '3456789', 'customer', '', 'tamil.sat92', 'thiva@gmail.com', '25894536241', 'Namakkal', 'SBIN0008');
